        ...
        public string SendEmail(string to)
        {
            try
            {
                using (var smtpClient = new SmtpClient(_smtpServer, int.Parse("587")))
                {
                    ...
                    smtpClient.Credentials = new NetworkCredential(_smtpUsername, "iovhkehgbygtuvrl"); // "rfdjmgltrtwvgihj" yazan yere şifre gelecek BURAYA ŞİFRE GELECEK yay
                    ...
                    _logger.LogInformation($"ooooooooooooooooooooooo {to}, {_smtpPassword} = \"fmvxuhvjsjbhwkod\", {_smtpServer} {_smtpUsername}  {mailMessage} ");
